...
The submission scripts depend on the presence of `numpy`. If you are missing any of these packages, install them from the online Python registries. The easiest way to do this is through pip:
